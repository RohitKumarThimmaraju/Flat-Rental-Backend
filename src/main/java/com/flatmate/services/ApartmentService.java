...
import com.flatmate.dtos.ApartmentResponseDTO;
...
public class ApartmentService {
	@Autowired
	private ApartmentRepository arepo;
	@Autowired
	...
	public List<Apartment> search(SearchDTO dto) {
		if (dto.getGender().equals("All") && dto.getFurnish().equals("All") && dto.getAtype().equals("All"))
			...
			return arepo.findByGenderAndFlattypeAndFurnishtypeAndIsactive(dto.getGender(), dto.getAtype(),
					dto.getFurnish(), true);
	}
